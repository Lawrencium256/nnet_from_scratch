...
I have verified that the forward and backwards propagation are working correctly (using PyTorch).
I could add list comprehensions to the backprop() and update_params() functions, but I quite like how they are atm.
------------------------------------------------------------------------------------------------------------------------
"""
import numpy as np
import random
